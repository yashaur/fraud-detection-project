    ...
    if st.button("Cycle Random Demo Values"):
        ...
        for k in field_names:
            if k == 'hour_of_day':
                ...
                trans_type = random_sample[0][k]
                trans_type = trans_type.replace('_', ' ').title()
                st.session_state[k] = trans_type 
            else:
    ...
    if None in input.values():
        ...
        with st.expander("🤔 Reason for classification"):
            ...
            if prediction == 1:
                ...
                st.info(
                    f"🔎 The strongest contributor was **{shap_top}**, "
                ...
                st.info(
                    f"🔎 The strongest contributor was **{shap_bottom}**, "
